...
from solver import SolverVA
from config import *

# use this command to 'awake' the network?
# $python -m visdom.server
# use tensorboard
# $tensorboard --logdir=/research/dept2/qxlai/VariationalAttention/summary/ --bind_all --port=6001
